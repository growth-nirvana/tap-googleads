...
from tap_googleads.streams import (
    ...
    CampaignReportByMonthStream,
    CampaignReportByHourStream,
    CityReportStream,
    ...
    LabelReportStream,
    LabelStream,
    LandingPageReportStream,
    LandingPageReportCustomConversionsStream,
    MetroReportStream,
    ...
    ResponsiveSearchAdAssetStream,
    SearchQueryReportStream,
    SearchQueryReportCustomConversionsStream,
    ShoppingReportStream,
    ShoppingReportCustomConversionsStream,
    VideoStream,
    VideoReportStream,
